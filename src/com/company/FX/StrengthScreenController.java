...
public class StrengthScreenController {
    ...
    public void loadStrength() {
        List<Character> characters = Database.selectCharactersByClass("Strength");
        ...
        TableColumn<Object, Object> hpRegenerationColumn = new TableColumn<>("HP Regeneration (%)");
        hpRegenerationColumn.setCellValueFactory(new PropertyValueFactory<>("feature"));

        tableViewCharacters.getColumns().addAll(classColumn, nameColumn, hpRegenerationColumn);
